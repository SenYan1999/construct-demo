...
if __name__ == '__main__':
    model_option = st.selectbox(
        'Embedding LLM',
        ('WhereIsAI/UAE-Large-V1', 'avsolatorio/GIST-large-Embedding-v0', 'llmrails/ember-v1'))
    ...
    # prepare data
    option_prefix = {'WhereIsAI/UAE-Large-V1': 'uae-large', 'avsolatorio/GIST-large-Embedding-v0': 'gist-large', 'llmrails/ember-v1': 'emberv1'}
